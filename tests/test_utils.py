...
from src.utils import greetings, cards_reading, top_transactions, actual_currencies, stock_prices
import os
...
def test_cards_reading(transactions_data):
    assert cards_reading("2021-12-25 15:12:33", "2021-12-01 15:12:33", transactions_data) == [
        {
            "Номер карты": "*4556",
            "Сумма операции": -952.9,
            "Кешбек": 9.53
        },
        {
            "Номер карты": "*5091",
            "Сумма операции": -13136.0,
            "Кешбек": 131.36
        },
        {
            "Номер карты": "*7197",
            "Сумма операции": -18525.69,
            "Кешбек": 185.26
        }
    ]
